...
<h1 align="center">
  Gatsby PaperCSS Landing Page Starter
</h1>

This project is based on gillkyles work here: https://github.com/gillkyle/gatsby-starter-landing-page
...
```bash
gatsby new landing-page https://github.com/manzanillo/gatsby-starter-paper-css-landing-page.git
```
...
[![Edit gatsby-starter-portfolio-cara](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/manzanillo/gatsby-starter-paper-css-landing-page/tree/master/)
